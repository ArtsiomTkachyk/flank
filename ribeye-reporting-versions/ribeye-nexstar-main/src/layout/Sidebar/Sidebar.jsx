...
import nexstarLogo from "../../assets/images/nexstar-nav-logo.png";
...
const Sidebar = ({ showMenu, setShowMenu }) => {
  return (
    <>
      {/* Sidebar container */}
      <div
        className={`py-4 sidebar flex flex-col justify-between z-30 shadow fixed lg:sticky left-0 top-[0] w-[300px] bg-[#10172A] h-[100vh] mt-[1px] px-4
          ${showMenu ? "show_menu" : "hide_menu"}
          `}
      >
        <div className="flex flex-col w-full">
          <div className="w-full">
            <img className="mx-auto" src={nexstarLogo} alt="" />
          </div>
