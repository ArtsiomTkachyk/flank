      ...
      <div className="w-full space-y-10 px-4 py-6">
        <div ref={parent}>
          <div className="flex items-center justify-between">
            <button
              ...
              } px-2 py-2 rounded-md  gap-1 filter-btn active:bg-slate-700 self-end transition-colors text-white`}
              onClick={() => {
                setShow(true);
                setShowFilter(true);
              }}
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-x-3 gap-y-5 justify-between">
            <div className="flex w-full sm:w-[47%] md:w-[24%] min-w-[250px] min-h-[100px] justify-center rounded-lg bg-[#fff] shadow-shadowInset10 flex-col px-4 py-2 border border-solid border-[rgba(112, 128, 144, 0.10)]">
              <h2 className="text-base font-semibold">Impressions</h2>
              <div className="w-full text-[#000] flex justify-between ">
                <span className="text-2xl font-semibold text-[#44C4F6]">
                  {selectedAdvertisments.Advertiser === "Select..."
                    ? totalImpressions
                    : selectedAdvertisments.Advertiser !== "Select..." &&
                      selected["Campaign Name"] === "Select..."
            ...
            <div className="flex w-full sm:w-[47%] md:w-[24%] min-w-[250px] min-h-[100px] justify-center rounded-lg bg-[#fff] shadow-shadowInset10 flex-col px-4 py-2 border border-solid border-[rgba(112, 128, 144, 0.10)]">
              ...
              <div className="w-full text-[#000] flex justify-between ">
                <span className="text-2xl font-semibold text-[#F37F7F]">
                  {selectedAdvertisments.Advertiser === "Select..."
                    ? totalReach
                    : selectedAdvertisments.Advertiser !== "Select..." &&
                      selected["Campaign Name"] === "Select..."
            ...
            <div className="flex w-full sm:w-[47%] md:w-[24%] min-w-[250px] min-h-[100px] justify-center rounded-lg bg-[#fff] shadow-shadowInset10 flex-col px-4 py-2 border border-solid border-[rgba(112, 128, 144, 0.10)]">
              ...
              <div className="w-full text-[#000] flex justify-between ">
                <span className="text-2xl font-semibold text-[#72D4CA]">
                  {selectedAdvertisments.Advertiser === "Select..."
            ...
            <div className="flex w-full sm:w-[47%] md:w-[24%] min-w-[250px] min-h-[100px] justify-center rounded-lg bg-[#fff] shadow-shadowInset10 flex-col px-4 py-2 border border-solid border-[rgba(112, 128, 144, 0.10)]">
              ...
              <div className="w-full text-[#000] flex justify-between ">
                <span className="text-2xl font-semibold text-[#CB99FA]">
                  {selectedAdvertisments.Advertiser === "Select..."
        ...
        <div className="my-20 ">
          {selectedAdvertisments.Advertiser !== "Select..." && (
            <>
              {/* <h1 className="font-bold text-4xl text-center mb-4">Heat Map</h1> */}
