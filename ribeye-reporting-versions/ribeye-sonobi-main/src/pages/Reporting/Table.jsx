    ...
    datasets: [
      {
        ...
        backgroundColor: "#2E203A",
      },

      {
        label: "Reach",
        data: chartDataSetsData[0]?.map((val) => val.Reach),
        backgroundColor: "#A10043",
      },
      {
        label: "Frequency",
          ...
          {linkButtons.map((link) => (
            <Link
              ...
              ${
                ...
                selectedAdvertiser.Advertiser !== "Select..."
                  ? "bg-[#C00753] border-[#C00753] text-[#fff]"
                  : "bg-[#fff] border-[#000] text-[#000]"
              }
 border border-solid  rounded-full text-sm font-medium  px-5 py-2`}
            >
              {link.label}
            </Link>
          ))}
