...
import ribeyeLogo from "../../assets/images/ribeye-logo.svg";
...
const Sidebar = ({ showMenu, setShowMenu }) => {
  return (
    <>
      {/* Sidebar container */}
      <div
        className={`py-4 sidebar flex flex-col justify-between z-30 shadow fixed lg:sticky left-0 top-[0] w-[300px] bg-[#141718] h-[100vh] mt-[1px] px-4
          ${showMenu ? "show_menu" : "hide_menu"}
          `}
      >
        <div className="flex flex-col w-full">
          <div className="w-full">
            <img className="mx-auto" src={ribeyeLogo} alt="" />
          </div>
          <div className="sidebar_scroll flex flex-col gap-y-3 mt-12 max-h-[70vh] overflow-auto">
            <NavLink
              ...
              to="/reporting"
              className={({ isActive }) =>
                `flex items-center px-5 py-3 rounded-[8000px] ${
                  isActive ? "active_link" : "inactive"
                }`
              }
            >
              <img className="mr-4" src={reporting} alt="reporting" />
              <h5 className="text-sm font-semibold text-[#E8ECEF] opacity-[0.75]">
                Reporting
              </h5>
            </NavLink>
            <NavLink
